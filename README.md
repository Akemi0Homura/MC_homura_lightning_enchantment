This content was translated by AI.<br>

为我的世界添加了一个闪电附魔。<br>
Adds a Lightning Enchantment to Minecraft.<br>
<br>
获取方式：附魔台(剑)，村民交易，钓鱼。<br>
Obtained via: Enchanting Table (Sword), Villager Trades, Fishing.<br>
<br>
生效武器：剑。<br>
Effective on: Swords.<br>
<br>
优点：<br>
Advantages:<br>
...
<br>
缺点：由于闪电是纯特效，因此攻击苦力怕和村民，不会将其转化为闪电苦力怕和女巫。<br>
Disadvantage:Since the lightning is purely cosmetic, attacking Creepers or Villagers will not transform them into Charged Creepers or Witches, respectively.<br>
<br>
特点：该附魔在生存模式只能附魔到剑上，但如果是创造模式附魔到弓、弩、三叉戟、雪球、方块等等，附魔都会生效。<br>
Special Feature:In Survival mode, this enchantment can only be applied to swords. However, in Creative mode, if applied to bows, crossbows, tridents, snowballs, blocks, etc., the enchantment will still function as intended.
